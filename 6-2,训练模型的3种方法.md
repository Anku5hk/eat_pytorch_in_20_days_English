...
Let's take the training of the classification model of the minist data set as an example to demonstrate the styles of these three training models.

Among them, we will use two methods of torchkeras.Model and torchkeras.LightModel in the training loop of class form.
...
Script style training loops are the most common.
...
### Second, function style


This style makes simple function encapsulation in script form.
...
def valid_step(model,features,labels):
    ...
    # Prediction mode, the dropout layer does not work
    model.eval()
...
### Three, class style torchkeras.Model


Here torchkeras.Model is used to build the model, and the compile method and fit method are called to train the model.

The training model using this form is very concise and clear.
...
### Fourth, class style torchkeras.LightModel


The following demonstrates the usage example of torchkeras.LightModel, detailed usage can refer to
